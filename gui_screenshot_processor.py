...
class ScreenshotProcessorGUI:
    ...
    def check_dependencies(self):
        ...
        try:
            ...
            self.log_output(f"🐍 Python executable: {self.python_exe}")
    ...
    def create_sample(self):
        ...
        self.run_command([self.python_exe, "url_screenshot_processor.py", "--create-sample"])
    ...
    def start_processing(self):
        ...
        # Build command using the correct Python executable
        cmd = [self.python_exe, "url_screenshot_processor.py", self.input_file.get()]
